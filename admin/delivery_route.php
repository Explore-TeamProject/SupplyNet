...
<head>
    ...
    <title>Deliveries & Routes - SupplyNet Admin</title>
...
<div class="sidebar">
    ...
    <div class="mt-4">
        ...
        <div class="nav-item"><a href="delivery_route.php" class="nav-link active"><i class="fas fa-route"></i> Deliveries & Routes</a></div>
...
<div class="main-wrapper">
    <div class="topbar">
        <div class="d-flex align-items-center">
            ...
            <h4 class="m-0 fw-bold text-dark">Deliveries & Routes</h4></div>
    ...
    <div class="dashboard-content">
        <div class="card card-custom p-4">
            <h5 class="mb-3">Welcome to Deliveries & Routes</h5>
            <p class="text-muted">This page is under construction. Features for assigning routes and managing deliveries will be implemented here soon.</p>
        </div>
    </div>
