...
<head>
    ...
    <title>Admin Profile - SupplyNet</title>
    <!-- Fonts -->
    ...
    <style>
        ...
        .form-label { font-weight: 600; color: #4e73df; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05rem; }
        
        /* Profile Image Badge */
        .profile-img-lg { width: 120px; height: 120px; border-radius: 50%; border: 4px solid #fff; box-shadow: 0 0.25rem 1rem rgba(0,0,0,0.15); }
        .profile-header-bg { background: linear-gradient(135deg, var(--primary-color) 0%, #224abe 100%); height: 120px; border-radius: 0.75rem 0.75rem 0 0; }
        ...
        @media (max-width: 768px) {
            ...
            #profileTabs { flex-direction: column; gap: 0.5rem; }
            #profileTabs .nav-link { width: 100%; text-align: left; background: #f8f9fc !important; border: 1px solid #eee !important; color: #858796 !important;}
            #profileTabs .nav-link.active { background: var(--primary-color) !important; color: #fff !important; border-color: var(--primary-color) !important; }
            
            .profile-details-wrapper { margin-top: -50px; }
    ...
    <div class="topbar">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-2 ms-md-0">
                <h4 class="m-0 fw-bold text-dark fs-5 fs-md-4">Admin Profile</h4>
                <p class="text-muted small mb-0 d-none d-md-block">Manage your administrative identity and security parameters.</p>
            </div>
        </div>
        ...
        <li><a class="dropdown-item text-center small text-primary fw-bold py-2 bg-light rounded-bottom text-decoration-none" href="?mark_read=true"><i class="fas fa-check-double me-1"></i>Mark all as read</a></li>
            ...
            <div class="dropdown">
                <a class="text-decoration-none topbar-user dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                    ...
                    <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($display_name); ?>&background=4e73df&color=fff" alt="Profile">
                </a>
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card card-custom h-100">
                    ...
                    <div class="profile-details-wrapper position-relative px-4">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($current_user['UserName']); ?>&background=4e73df&color=fff&size=200" alt="Profile Image" class="profile-img-lg mb-3">
                        ...
                        <div class="mt-3">
                            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle px-3 py-2 fs-6 rounded-pill text-uppercase">
                                <i class="fas fa-shield-alt me-2"></i><?php echo htmlspecialchars($current_user['Role']); ?>
                            </span>
                        </div>
                        ...
                        <div class="tab-content" id="profileTabsContent">
                            ...
                            <div class="tab-pane fade" id="change-security" role="tabpanel">
                                <div class="alert alert-info border-info border-opacity-25 bg-info bg-opacity-10 d-flex align-items-center mb-4">
                                    ...
                                    <div class="small text-dark">If you enter a new password, your account will instantly update. Ensure to save it somewhere safe.</div>
                                </div>
                                <form method="POST">
