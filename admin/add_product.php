...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="mt-4">
            ...
            <div class="nav-item"><a href="user_management.php" class="nav-link"><i class="fas fa-users"></i> User
                    Management</a></div>
            <div class="nav-item"><a href="products_directory.php" class="nav-link active"><i
                        class="fas fa-box-open"></i> Products Directory</a></div>
    ...
    <div class="main-wrapper">
        ...
        <div class="dashboard-content">
            ...
            <div class="mb-4">
                <a href="products_directory.php" class="btn btn-secondary shadow-sm"><i
                        class="fas fa-arrow-left me-2"></i>Back to Directory</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card card-custom">
                        <div class="card-header bg-white border-bottom py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="font-weight: 700;"><i
                                    class="fas fa-box me-2"></i>Product Details</h6>
                        </div>
                            ...
                            <form action="add_product.php" method="POST">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="product_name" name="product_name"
                                        placeholder="Enter the product's official name" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-light border-end-0 fw-bold text-secondary px-3"
                                            style="border-radius: 0.5rem 0 0 0.5rem;">₹</span>
                                        <input type="number" step="0.01" min="0.01"
                                            class="form-control border-start-0 ps-0" id="price" name="price"
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="5"
                                        placeholder="Provide full features and product specifications here..."></textarea>
                                </div>

                                <div
                                    class="alert alert-info border-info border-opacity-25 bg-info bg-opacity-10 d-flex align-items-center mb-4">
                                    <i class="fas fa-info-circle fs-4 text-info me-3"></i>
                                    <div>
                                        <strong>Inventory Note:</strong> Since production is purely order-driven, this
                                        product will initially be added to the catalog with <strong>0 units</strong> in
                                        stock. Stock tracking is handled via production orders later.
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="products_directory.php"
                                        class="btn btn-light border fw-bold text-secondary px-4">Cancel</a>
                                    <button type="submit" class="btn btn-primary fw-bold px-4 shadow-sm"><i
                                            class="fas fa-save me-2"></i>Save Product Catalog</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 d-none d-lg-block">
                    <div class="card card-custom bg-primary text-white text-center p-5 h-100 d-flex flex-column justify-content-center align-items-center"
                        style="background: linear-gradient(135deg, #4e73df 0%, #224abe 100%);">
                        <i class="fas fa-cube text-white-50 mb-3" style="font-size: 5rem;"></i>
                        <h5 class="fw-bold mb-3">Expand Your Inventory</h5>
                        <p class="text-white-50 small mb-0">Adding products to your supply chain registry allows
                            salesmen and customers to immediately start generating production orders for them.</p>
                    </div>
                </div>
            </div>
