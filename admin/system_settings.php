...
<head>
    ...
    <title>System Settings - SupplyNet Admin</title>
...
<div class="sidebar">
    ...
    <div class="mt-4">
        ...
        <div class="nav-item"><a href="system_settings.php" class="nav-link active"><i class="fas fa-cogs"></i> System Settings</a></div>
    </div>
</div>
...
<div class="main-wrapper">
    <div class="topbar">
        <div class="d-flex align-items-center">
            ...
            <h4 class="m-0 fw-bold text-dark">System Settings</h4></div>
    ...
    <div class="dashboard-content">
        <div class="card card-custom p-4">
            <h5 class="mb-3">Welcome to System Settings</h5>
            <p class="text-muted">This page is under construction. Features for application-wide settings will be implemented here soon.</p>
        </div>
    </div>
