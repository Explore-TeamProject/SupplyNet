...
<head>
    ...
    <title>Delivery Profile - SupplyNet</title>
    <!-- Fonts -->
    ...
    <style>
        ...
        .form-control:focus { border-color: var(--primary-color); box-shadow: 0 0 0 0.25rem rgba(231, 74, 59, 0.25); }
        .form-label { font-weight: 600; color: #e74a3b; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05rem; }
        
        /* Profile Image Badge */
        .profile-img-lg { width: 120px; height: 120px; border-radius: 50%; border: 4px solid #fff; box-shadow: 0 0.25rem 1rem rgba(0,0,0,0.15); }
        .profile-header-bg { background: linear-gradient(135deg, var(--primary-color) 0%, #be2617 100%); height: 120px; border-radius: 0.75rem 0.75rem 0 0; }
    ...
    <div class="topbar">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-2 ms-md-0">
                <h4 class="m-0 fw-bold text-dark fs-5 fs-md-4">Agent Profile</h4>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card card-custom h-100">
                    ...
                    <div class="profile-details-wrapper position-relative px-4">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($current_user['UserName']); ?>&background=e74a3b&color=fff&size=200" alt="Profile Image" class="profile-img-lg mb-3">
                        ...
                        <div class="mt-3">
                            <span class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle px-3 py-2 fs-6 rounded-pill text-uppercase">
                                <i class="fas fa-shipping-fast me-2"></i><?php echo htmlspecialchars($current_user['Role']); ?>
                            </span>
                        </div>
                            ...
                            <div class="tab-pane fade show active" id="edit-profile" role="tabpanel">
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <label class="form-label">Base Address / Area Details</label>
                                            <div class="input-group">
