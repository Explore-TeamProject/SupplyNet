...
<head>
    ...
    <title>Employee Profile - SupplyNet</title>
    <!-- Fonts -->
    ...
    <link rel="stylesheet" href="/SupplyNet/config/responsive-enhancements.css">
    <!-- FontAwesome -->
    ...
    <style>
        ...
        .profile-header-bg {
            background: linear-gradient(135deg, var(--primary-color) 0%, #13855c 100%);
            height: 120px;
...
<script>
    ...
    <!-- Sidebar -->
    <div class="sidebar">
        <a href="index.php" class="brand"><i class="fas fa-cubes me-2"></i>SupplyNet<br><small class="text-white-50"
                style="font-size: 0.7rem;">Employee Panel</small></a>
        <div class="mt-4">
            <div class="nav-item"><a href="index.php" class="nav-link"><i class="fas fa-tachometer-alt"></i>
                    Dashboard</a></div>
            <div class="nav-item"><a href="manageOrder.php" class="nav-link"><i class="fas fa-tasks"></i> Manage
                    Orders</a></div>
            <div class="nav-item"><a href="viewOrderHistory.php" class="nav-link"><i class="fas fa-history"></i> Order
                    History</a></div>
            <div class="nav-item"><a href="assignOrder.php" class="nav-link"><i class="fas fa-clipboard-check"></i>
                    Assign Orders</a></div>
            <div class="nav-item"><a href="routeAssign.php" class="nav-link"><i class="fas fa-map-marked-alt"></i> Route
                    Assign</a></div>
        </div>
    </div>
    ...
    <div class="main-wrapper">
        <div class="topbar">
            <div class="d-flex align-items-center">
                <button class="btn btn-link d-md-none text-dark me-2 px-0" id="sidebarToggle"><i
                        class="fas fa-bars fs-5"></i></button>
                <div class="ms-2 ms-md-0">
                    <h4 class="m-0 fw-bold text-dark fs-5 fs-md-4">Employee Profile</h4>
                </div>
            </div>
            <div class="d-flex align-items-center gap-3 gap-md-4">
                ...
                <div class="dropdown">
                    <a class="text-decoration-none topbar-user dropdown-toggle" href="#" role="button"
                        ...
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($display_name); ?>&background=1cc88a&color=fff"
                            alt="Profile">
                    </a>
        ...
        <div class="dashboard-content">
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="card card-custom h-100">
                        ...
                        <div class="profile-details-wrapper position-relative px-4">
                            <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($current_user['UserName']); ?>&background=1cc88a&color=fff&size=200"
                                alt="Profile Image" class="profile-img-lg mb-3">
                            <h4 class="fw-bold text-dark m-0"><?php echo htmlspecialchars($current_user['UserName']); ?>
                            </h4>
                            <div class="text-muted small mt-1">
                                <i
                                    class="fas fa-envelope me-1"></i><?php echo htmlspecialchars($current_user['Email']); ?>
                            </div>
                            <div class="mt-3">
                                <span
                                    class="badge bg-primary bg-opacity-10 text-primary border border-primary-subtle px-3 py-2 fs-6 rounded-pill text-uppercase">
                                    <i
                                        class="fas fa-user-tie me-2"></i><?php echo htmlspecialchars($current_user['Role']); ?>
                                </span>
                            </div>
                            <div class="mt-4 pt-3 border-top text-start">
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted small">Employee ID</span>
                                    <span class="fw-bold text-dark">SN-EMP-<?php echo str_pad($user_id, 4, '0', STR_PAD_LEFT); ?></span>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <span class="text-muted small">Access Level</span>
                                    <span class="badge bg-success-subtle text-success border border-success-subtle px-2">Standard</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header bg-white border-bottom py-3">
                            <ul class="nav nav-pills card-header-pills" id="profileTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active fw-bold" id="edit-profile-tab"
                                        data-bs-toggle="tab" data-bs-target="#edit-profile" type="button" role="tab"><i
                                            class="fas fa-user-edit me-2"></i>Personal Info</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fw-bold text-muted" id="change-security-tab"
                                        data-bs-toggle="tab" data-bs-target="#change-security" type="button"
                                        role="tab"><i class="fas fa-shield-alt me-2"></i>Security</button>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content" id="profileTabsContent">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control border-start-0 ps-0" name="mobile_number"
                                                        value="<?php echo htmlspecialchars($current_user['mobile_number'] ?? ''); ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-4">
                                                <label class="form-label">Home Address</label>
                                                <div class="input-group">
                                                    <span class="input-group-text bg-light align-items-start pt-3 border-end-0"><i
                                                            class="fas fa-map-marker-alt text-muted"></i></span>
                                                    <textarea class="form-control border-start-0 ps-0" name="address"
                                                        rows="3"><?php echo htmlspecialchars($current_user['address'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-end mt-2">
                                            <button type="submit" class="btn btn-success px-4 shadow-sm fw-bold"><i
                                ...
                                <div class="tab-pane fade" id="change-security" role="tabpanel">
                                    <div
                                        ...
                                        <i class="fas fa-shield-alt fs-4 text-warning me-3"></i>
                                        <div class="small text-dark">Protect your account with a strong password. You will be required to log in again after updating your credentials.</div>
                                    </div>
                                    <form method="POST">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control border-start-0 ps-0" name="current_password"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <label class="form-label text-dark">New Password <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <span class="input-group-text bg-light border-end-0"><i
                                                            class="fas fa-lock text-muted"></i></span>
                                                    <input type="password" class="form-control border-start-0 ps-0" name="new_password"
                                                        required minlength="6">
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label class="form-label text-dark">Confirm Password <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <span class="input-group-text bg-light border-end-0"><i
                                        ...
                                        <div class="text-end mt-2">
                                            <button type="submit" class="btn btn-danger px-4 shadow-sm fw-bold"><i
                                                    class="fas fa-lock me-2"></i> Change Password</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <!-- Profile Utility Footer Card -->
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card card-custom p-4 bg-light border-0">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h6 class="fw-bold text-dark mb-2"><i class="fas fa-info-circle text-primary me-2"></i>Account Security Status</h6>
                                <p class="text-muted small mb-3 mb-md-0">Your account is currently protected with standard encryption. Ensure your password is updated every 90 days as per corporate policy. If you notice any unauthorized access, please contact the IT Helpdesk immediately.</p>
                            </div>
                            <div class="col-md-4 text-md-end">
                                <a href="#" class="btn btn-outline-dark btn-sm rounded-pill px-4 me-2"><i class="fas fa-life-ring me-1"></i> Help Center</a>
                                <div class="d-inline-block small text-muted mt-2 mt-md-0 ms-md-2" style="font-size: 0.75rem;">
                                    <i class="fas fa-history me-1"></i> Last login: Today, <?php echo date('h:i A'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
