...
if ($t_res)
    $metrics['today_orders'] = $t_res->fetch_assoc()['cnt'];
...
if ($m_res)
    $metrics['month_orders'] = $m_res->fetch_assoc()['cnt'];
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" crossorigin="anonymous"
        rel="stylesheet">
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .card-custom .metric-value {
                font-size: 1.25rem;
            }

            .card-custom .metric-icon {
                font-size: 1.5rem;
            }
        }
    </style>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="dashboard-content">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-custom h-100 py-2" style="border-left: 0.25rem solid var(--primary-color);">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="metric-title" style="color: var(--primary-color);">Active Deliveries
                                    </div>
            ...
            <h6 class="mt-4 mb-3 fw-bold text-dark"><i class="fas fa-chart-line me-2 text-primary"
                    style="color:var(--primary-color) !important;"></i>Order Volume Reports</h6>
                    ...
                    <div class="card card-custom h-100 py-2 border-0 bg-white">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <h3 class="metric-value text-primary m-0"
                                    style="color:var(--primary-color) !important;">
                                    <?php echo $metrics['today_orders']; ?>
                                </h3>
                ...
                <div class="col-lg-7 mb-4">
                    <div class="card card-custom shadow-sm h-100">
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold" style="color: var(--primary-color);">7-Day Order Trajectory
                            </h6>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-5 mb-4">
                    <div class="card card-custom shadow-sm h-100">
                        <div class="card-header bg-white border-bottom py-3">
                            <h6 class="m-0 font-weight-bold" style="color: var(--primary-color);">Quick Actions & Links
                            </h6>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-center gap-3">
                            <a href="manageOrder.php"
                                class="btn btn-outline-secondary text-start p-3 fw-semibold hover-lift"><i
                                    class="fas fa-tasks text-info me-3 fs-5"></i> Process pending orders</a>
                            <a href="assignOrder.php"
                                class="btn btn-outline-secondary text-start p-3 fw-semibold hover-lift"><i
                                    class="fas fa-clipboard-check text-success me-3 fs-5"></i> Map assignments to
                                Drivers</a>
                            <a href="viewOrderHistory.php"
                                class="btn btn-outline-secondary text-start p-3 fw-semibold hover-lift"><i
                                    class="fas fa-history text-primary me-3 fs-5"></i> Browse processing history</a>
                        </div>
                    </div>
                </div>
            </div>
